...
function alertar(mensagem) {
  ...
  var id = gera_id(5),
      html = '<div data-id="' + id + '" class="col-12 alrt bg-' + tipo + ' reticencias py-2 display-none">' + '<div class="titulo">' + '<p class="m-0">' + mensagem + '<span class="float-right">' + (detalhes !== "" ? '<i class="fas fa-chevron-down text-muted expandir mx-2" title="Ver Mais"></i>' : '') + '<i class="fas fa-times text-muted fechar mx-2" title="Remover"></i>' + '</span>' + '</p>' + '</div>' + '<div class="detalhes display-none">' + detalhes + '</div>' + '</div>';
